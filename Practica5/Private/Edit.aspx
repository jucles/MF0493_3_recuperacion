<%@ Page Title="" Language="C#" MasterPageFile="~/Private/Maestra.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Practica5.Private.Edit" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
        <script type="text/javascript">
            function BorrarArchivo(empresa, archivo) {
                $.ajax({
                    type: "GET",
                    url: "Eliminar.aspx",
                    data: { param: archivo, param2: empresa },
                    contentType: "application/json",
                    dataType: "json",
                    success: function (datos) {
                        if (datos[0] == "OK") {
                            $("#zona1_tabla tr").each(function () {
                                if (this.cells[0].innerHTML == datos[1]) {
                                    $(this).hide(800);
                                    this.remove();
                                }

                            })
                            $("#zona1_tabla tr:last-child td").text(datos[2]);
                        }
                        else {
                            alert("Error: " + datos[1]);
                        }
    ...
    <style type="text/css">
        ...
        table#zona1_tabla td:first-child {
...
<asp:Content ID="Content3" ContentPlaceHolderID="zona1" runat="server">
    ...
    <fieldset>
        ...
        <div class="row">
            <div class="col-md-3">
                <asp:Image ID="foto" runat="server" Height="150px" Width="150px" />
                <br />
                <br />
            ...
            <div class="col-md-4">
                ...
                <div class="form-group">
                    ...
                    <asp:TextBox CssClass="form-control" ID="txtFnac" ToolTip="Fecha de fundación" runat="server" data-provide="datepicker"></asp:TextBox>
                </div>
                <div class="form-group">
