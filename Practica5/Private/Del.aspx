<%@ Page Title="" Language="C#" MasterPageFile="~/Private/Maestra.Master" AutoEventWireup="true" CodeBehind="Del.aspx.cs" Inherits="Practica5.Private.Del" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="zona1" runat="server">
       ...
       <fieldset>
        ...
        <div class="form-group">
            <asp:Button CssClass="btn btn-primary" Text="Eliminar" ID="btnGuardar" runat="server" />
